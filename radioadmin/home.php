<?php
	...
	$stmt = $auth_user->runQuery("SELECT * FROM users WHERE uid=:uid");
...
<title>welcome - <?php print($userRow['emel']); ?></title>
</head>
        ...
        <div id="navbar" class="navbar-collapse collapse">
          ...
          <ul class="nav navbar-nav navbar-right">
            ...
            <li class="dropdown">
			  ...
			  <span class="glyphicon glyphicon-user"></span>&nbsp;Hi' <?php echo $userRow['emel']; ?>&nbsp;<span class="caret"></span></a>
...
<div class="container-fluid" style="margin-top:80px;">
    ...
    <div class="container">
    	...
    	<label class="h5">welcome : <?php print($userRow['unama']); ?></label>
        <hr />
